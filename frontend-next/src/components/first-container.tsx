...
function ContainerOne(){
    return(<>
        <div className=" absolute flex flex-row md:flex-row lg:flex-row items-center justify-between w-full h-[650px] bg-[rgba(194,223,241,1)] p-5">
            <div className="relative left-0 right-10 max-w-2xl mx-auto flex flex-col justify-center items-start gap-y-6 text-left font-mongolian p-8">
            ...
            <div className="w-[45%] relative left-5 top-2">
                <img src="/womanBackground.png" alt="Woman Background" />
            </div>
        </div>
    </>);
}
